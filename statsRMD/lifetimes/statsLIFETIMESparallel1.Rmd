...
write.csv(lifetimedata, file = "1_2000_Lifetimes_dim_0_1_2.csv")
```
...
write.csv(max_lifetimes, file = "1_2000_Maximum_lifetimes_all_dims.csv")
```
...
write.csv(sd_lifetimes_dim12, file = "1_2000_sd_lifetimes_dim_1_2.csv")
```
...
write.csv(skew_lifetimes_dim12, file = "1_2000_skew_lifetimes_dim_1_2.csv")
```
...
write.csv(kurt_lifetimes_dim12, file = "1_2000_kurt_lifetimes_dim_1_2.csv")
```