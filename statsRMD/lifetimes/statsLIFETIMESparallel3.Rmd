...
write.csv(lifetimedata, file = "4000_6000_Lifetimes_dim_0_1_2.csv")
```
...
write.csv(max_lifetimes, file = "4001_6000_Maximum_lifetimes_all_dims.csv") 
```
...
write.csv(skew_lifetimes_dim12, file = "4001_6000_skew_lifetimes_dim_1_2.csv")
```
...
write.csv(kurt_lifetimes_dim12, file = "4001_6000_kurt_lifetimes_dim_1_2.csv")
```
